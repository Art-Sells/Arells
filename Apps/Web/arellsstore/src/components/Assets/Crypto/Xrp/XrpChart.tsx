...
const XrpChart: React.FC<Props> = ({
  history = [],
  color = 'rgba(30, 41, 59, 0.92)',
  activeColor = 'rgba(15, 23, 42, 1)',
  markerColor = 'rgba(15, 23, 42, 1)',
  ...
  markerShadow = '-5px 0 14px rgba(30, 41, 59, 0.2), 0 7px 10px rgba(15, 23, 42, 0.12)',
  animateOn = true,
  animateDelayMs = 0,
