...
const ASSET = STOCK_ASSET_BY_ID.apple;

const PREVIEW_SKIP_SESSION_DELETES = false;


type VavityAppleProps = {
  sessionMountClearGuardRef: React.MutableRefObject<boolean>;
};

const VavityApple: React.FC<VavityAppleProps> = ({ sessionMountClearGuardRef }) => {
    ...
    const loadRangePrice = async () => {
      ...
      try {
        const [solidResp, liquidResp] = await Promise.all([
          axios.get('/api/assets/stocks/apple/appleVapaHistoricalPrice', { params: { date: isoDate, mode: 'solid' } }),
          axios.get('/api/assets/stocks/apple/appleVapaHistoricalPrice', { params: { date: isoDate, mode: 'liquid' } }),
        ]);
  ...
  useEffect(() => {
    ...
    const loadMock = async () => {
      try {
        const resp = await axios.get('/api/assets/stocks/apple/appleMockPortfolio');
  ...
  useEffect(() => {
    ...
    const loadHistorical = async () => {
      ...
      try {
        const [solidResp, liquidResp] = await Promise.all([
          axios.get('/api/assets/stocks/apple/appleVapaHistoricalPrice', {
      ...
      <div className="asset-invest-form">
        <div className="asset-submit-form">
          <div className="asset-metric-row asset-invest-form-heading">
            <span className="asset-metric-title--apple" style={{ fontWeight: 800 }}>
              {label}
            </span>
          </div>

          <div className="asset-invest-form-body asset-invest-form-body--apple">
            <div className="asset-invest-form-metrics-panel asset-invest-form-metrics-panel--apple">
              <div className="asset-invest-form-metrics">
                <div className="asset-metric-row asset-invest-form-row">
                  <span className="asset-metric-title--apple asset-invest-form-metric-title">Purchased Value</span>
                  <span
                ...
                <div className="asset-metric-row asset-invest-form-row">
                  <span className="asset-metric-title--apple asset-invest-form-metric-title">Current Value</span>
                  <span
                ...
                <div className="asset-metric-row asset-invest-form-row">
                  <span className="asset-metric-title--apple asset-invest-form-metric-title">{profitRow.title}</span>
                  <span
                    className={`asset-money-wrap asset-profit-range-anim${
                      formValuesHidden || formCalcHidden ? ' is-hidden' : ''
                    }`}
                  ...
                  >
                    {profitRow.prefix ? (
                      <span className="asset-metric-inline-symbol--apple">{profitRow.prefix}</span>
                    ) : null}
            ...
            <div className="asset-invest-form-controls asset-invest-form-controls--apple">
              <div className="asset-invest-form-field">
                <div className="asset-metric-row asset-invest-form-field-label">
                  <span className="asset-metric-title--apple">{ASSET.ticker} amount</span>
                </div>
                <div className="asset-invest-form-field-control">
                  <input
                    className="asset-invest-input asset-invest-input--apple"
                    type="text"
                    inputMode="decimal"
                    pattern="^[0-9]*\\.?[0-9]*$"
                    value={tokenAmount}
              ...
              <div className="asset-invest-form-field">
                <div className="asset-metric-row asset-invest-form-field-label">
                  <span className="asset-metric-title--apple">Date purchased</span>
                </div>
                <div className="asset-invest-form-field-control">
  ...
  return (
    <>
      <div className="asset-page-content asset-page-content--apple page-slide-down">
      <div
        className="asset-panel asset-panel--apple asset-header-panel asset-section-slide"
        ref={headerPanelRef}
      >
        <a
          className="asset-title-badge asset-title-badge--apple asset-title-badge--section"
        ...
        <div
          className="asset-panel asset-panel--apple asset-price-chart-row asset-price-chart-row--combined"
          style={{ overflow: 'visible' }}
      >
          <div
            className="asset-price-panel asset-price-panel--apple asset-section-slide"
            style={{
              padding: '30px',
      ...
      >
            <div className="asset-metric-row">
              <span className="asset-metric-title--apple">Price:</span>
              <span className="asset-metric-value-wrap">
                {!headerNumbersVisible && (
                  <span className={`asset-number-loader asset-number-loader--apple asset-number-loader--overlay${shimmersFading ? ' is-hidden' : ''}`} />
                )}
                <span className={`asset-metric-symbol--apple asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`}>$</span>
            ...
            <div className="asset-metric-row">
              <span className="asset-metric-title--apple">Market Cap:</span>
              <span className="asset-metric-value-wrap">
                {!headerNumbersVisible && (
                  <span className={`asset-number-loader asset-number-loader--apple asset-number-loader--wide asset-number-loader--overlay${shimmersFading ? ' is-hidden' : ''}`} />
                )}
                <span className={`asset-metric-symbol--apple asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`}>$</span>
                <span className="asset-header-switch-fade" style={realityFadeStyle}>
                  <span className={`asset-metric-value asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`}>
            ...
            <div className="asset-metric-row">
              <span className="asset-metric-value-wrap">
                {!headerNumbersVisible && (
                  <span className={`asset-number-loader asset-number-loader--apple asset-number-loader--narrow asset-number-loader--overlay${shimmersFading ? ' is-hidden' : ''}`} />
                )}
              {percentageIncrease > 0 ? (
                <span className={`asset-metric-trend-icon asset-metric-trend-icon--apple asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`} aria-hidden="true" />
              ) : (
                <span
                  className={`asset-metric-trend-icon asset-metric-trend-icon--down asset-metric-trend-icon--apple asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`}
                  aria-hidden="true"
                />
              )}
              <span
              ...
              <span
                className={`asset-metric-symbol--apple asset-metric-percent-symbol--apple asset-mount-fade-2s${
            ...
            <div
              className="asset-panel asset-panel--apple asset-section-slide asset-market-controls"
            >
              <div className="asset-market-controls-header">
                <div className="asset-profit-summary asset-profit-summary--apple" style={{ marginBottom: 0 }}>
                  <div className="asset-metric-inline-row">
                    {(() => {
                      ...
                      return (
                        <>
                          <span className="asset-metric-inline-title--apple asset-market-status-title">
                            {label}:
                          </span>{' '}
                          <span
                ...
                {chartRanges.map((range) => {
                  ...
                  return (
                    <button
                      key={range.label}
                      type="button"
                      className={`asset-range-button asset-range-button--apple${isActive ? ' is-active' : ''}`}
          ...
          <div
              className="asset-panel asset-panel--apple asset-section-slide asset-chart-panel asset-chart-panel--apple"
            style={{
              padding: '0px',
                position: 'relative',
          ...
          >
            {chartHoverPoint != null && displayPoint && (
                <div className="asset-chart-date-badge asset-chart-date-badge--apple">
                <span className="asset-metric-inline-title--apple">Date:</span>{' '}
              ...
              <div className={`asset-chart-loader${chartReady && !forceChartLoader ? ' is-hidden' : ''}`}>
                <div className="asset-chart-grid-shimmer asset-chart-grid-shimmer--apple">
              ...
              <div
                ...
                style={{
                  ...
                  zIndex: 0,
                  backgroundImage:
                    'repeating-linear-gradient(to right, rgba(85, 85, 85, 0.1) 0px, rgba(85, 85, 85, 0.1) 1px, transparent 1px, transparent 30px), repeating-linear-gradient(to bottom, rgba(85, 85, 85, 0.1) 0px, rgba(85, 85, 85, 0.1) 1px, transparent 1px, transparent 30px)',
                }}
              />
              <div
            ...
            <AppleChart
              history={chartHistoryForLine || []}
                  ...
                  activeColor="rgba(85, 85, 85, 0.6)"
                  markerColor="rgba(85, 85, 85, 1)"
                  gridColor="transparent"
                  gridSpacing={30}
                  height={chartCanvasHeight}
                  interactiveHeight={chartPanelHeight}
                  canvasOffsetTop={chartTopPadding}
                  backgroundColor="rgba(85, 85, 85, 0.16)"
                  markerShadow="-5px 0 14px rgba(85, 85, 85, 0.26), 0 7px 10px rgba(85, 85, 85, 0.18)"
                  animateOn={false}
                  animateDelayMs={0}
          ...
          <div className="asset-panel asset-panel--apple asset-reality-toggle-shell">
            <div className="asset-reality-toggle-row asset-reality-toggle-row--apple">
      ...
      <div
        className={`asset-panel asset-panel--apple asset-portfolio-center asset-section-slide${
      ...
      >
        {!hasInvestmentsUI && !showInitialFetchLoader ? (
          <>
            ...
            >
              ...
              >
                <button
                  className="asset-action-button asset-action-button--apple asset-action-button--invest-add asset-action-button--add-investments"
          ...
          <>
            ...
            <div
              ...
              className={`asset-slide-panel${isClearingInvestments ? ' asset-slide-panel--clearing asset-slide-panel--clearing-apple' : ''}`}
              style={{
            ...
            >
              <div ref={investmentsWholeContentRef}>
                {showInvestmentsHeader && (
                  <h2 className="asset-investments-header">
                    <span className="asset-portfolio-title-muted">my apple</span>
                  </h2>
                )}
                <div
                  className={`asset-portfolio-summary-box asset-portfolio-summary-box--apple${
              ...
              <div className="asset-metric-row asset-money-row" style={{ marginBottom: '8px', justifyContent: 'center' }}>
                <span className="asset-metric-title--apple" style={{ display: 'inline-block', marginTop: 30 }}>
                  Purchased Value
                </span>
                <div
              ...
              <div className="asset-metric-row asset-money-row" style={{ marginBottom: '8px', justifyContent: 'center' }}>
                <span className="asset-metric-title--apple">
                  Current Value
                </span>
                <div
                  ref={currentValueRef}
              ...
              <div
                className="asset-panel asset-panel--apple asset-profit-block asset-slide-in"
                style={{ 
                  padding: '20px 20px 20px', marginBottom: '10px', width: '92%', marginLeft: 'auto', marginRight: 'auto' }}
              >
                <div className="asset-profit-summary asset-profit-summary--apple">
                  <div className="asset-metric-inline-row">
                {(() => {
                        ...
                        return (
                          ...
                          >
                            <span ref={profitInlineAnimRef} className="asset-profit-range-anim">
                              <span className="asset-metric-inline-title--apple">
                              ...
                              >
                                ...
                                >
                                  <span className="asset-metric-symbol--apple">
                                    {isProfit ? '+$' : '-$'}
                                  </span>
              ...
              <div className="asset-portfolio-actions asset-portfolio-actions--add">
                <button
                  className={`asset-action-button asset-action-button--apple asset-action-button--invest-add${
          ...
          <div className="asset-empty-addinvest">
            ...
            >
              Add Investments
                ...
                >
                  <button
                    className={`asset-action-button asset-action-button--apple asset-action-button--invest-show${
                ...
                {showInvestmentsList && (
                  ...
                  >
                    ...
                    <div
                      className={`asset-investments-wrap asset-investments-wrap--apple asset-slide-panel${
                        ...
                        return (
                          <React.Fragment key={investmentId}>
                            ...
                            >
                              ...
                              <div
                                className={`asset-panel asset-panel--apple${isPendingDelete ? ' is-pending-delete' : ''}${
                              ...
                              <div className="asset-investment-metrics">
                                  ...
                                  <div className="asset-metric-row asset-money-row" style={{ justifyContent: 'center' }}>
                                    <span className="asset-metric-title--apple">Current Value</span>
                                    <span className="asset-money-wrap">
                                      <span className="asset-metric-symbol--apple">$</span>
                                      <span className="asset-metric-value">
                                  ...
                                  <div className="asset-metric-row asset-money-row" style={{ justifyContent: 'center' }}>
                                    {(() => {
                                      ...
                                      return (
                                        <>
                                          <span className="asset-metric-title--apple">{title}</span>
                                          <span className="asset-money-wrap">
                                            <span className="asset-metric-inline-symbol--apple">{prefix}</span>
                                            <span className="asset-metric-value">
                                  ...
                                  <button
                                    type="button"
                                    className="asset-range-button asset-range-button--apple asset-delete-button asset-investment-delete-button"
        ...
        {shouldRenderAddForm && (
          ...
          >
            <div className="asset-portfolio-summary-box asset-portfolio-summary-box--apple">
              <div
