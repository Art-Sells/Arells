...
const VavityBitcoin: React.FC<VavityBitcoinProps> = ({ sessionMountClearGuardRef }) => {
    ...
    const loadRangePrice = async () => {
      ...
      try {
        const [solidResp, liquidResp] = await Promise.all([
          axios.get('/api/assets/crypto/bitcoin/bitcoinVapaHistoricalPrice', { params: { date: isoDate, mode: 'solid' } }),
          axios.get('/api/assets/crypto/bitcoin/bitcoinVapaHistoricalPrice', { params: { date: isoDate, mode: 'liquid' } }),
        ]);
  ...
  useEffect(() => {
    ...
    const loadHistorical = async () => {
      ...
      try {
        const [solidResp, liquidResp] = await Promise.all([
          axios.get('/api/assets/crypto/bitcoin/bitcoinVapaHistoricalPrice', {
          ...
          <div className="asset-invest-form-body asset-invest-form-body--bitcoin">
            ...
            <div className="asset-invest-form-controls asset-invest-form-controls--bitcoin">
              ...
              <div className="asset-invest-form-field">
                ...
                <div className="asset-invest-form-field-control">
                  <CustomDatePicker value={purchaseDate} onChange={setPurchaseDate} placeholder="MM/DD/YYYY" asset="bitcoin" />
                </div>
              </div>
        ...
        {!hasInvestmentsUI && !showInitialFetchLoader ? (
          ...
          <>
            ...
            >
              ...
              <div
                className="asset-panel asset-panel--bitcoin asset-profit-block asset-slide-in"
                style={{ 
