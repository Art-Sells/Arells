...
type VavityAlphabetProps = {
  sessionMountClearGuardRef: React.MutableRefObject<boolean>;
};

const VavityAlphabet: React.FC<VavityAlphabetProps> = ({ sessionMountClearGuardRef }) => {
  ...
  useEffect(() => {
    ...
    const bg = 'rgba(66, 133, 244, 0.075)';
    ...
    const loadRangePrice = async () => {
      ...
      try {
        const [solidResp, liquidResp] = await Promise.all([
          axios.get('/api/assets/stocks/alphabet/alphabetVapaHistoricalPrice', { params: { date: isoDate, mode: 'solid' } }),
          axios.get('/api/assets/stocks/alphabet/alphabetVapaHistoricalPrice', { params: { date: isoDate, mode: 'liquid' } }),
        ]);
  ...
  useEffect(() => {
    ...
    const loadMock = async () => {
      try {
        const resp = await axios.get('/api/assets/stocks/alphabet/alphabetMockPortfolio');
  ...
  useEffect(() => {
    ...
    const loadHistorical = async () => {
      ...
      try {
        const [solidResp, liquidResp] = await Promise.all([
          axios.get('/api/assets/stocks/alphabet/alphabetVapaHistoricalPrice', {
      ...
      <div className="asset-invest-form">
        <div className="asset-submit-form">
          <div className="asset-metric-row asset-invest-form-heading">
            <span className="asset-metric-title--alphabet" style={{ fontWeight: 800 }}>
              {label}
            </span>
          </div>

          <div className="asset-invest-form-body asset-invest-form-body--alphabet">
            <div className="asset-invest-form-metrics-panel asset-invest-form-metrics-panel--alphabet">
              <div className="asset-invest-form-metrics">
                ...
                <div className="asset-metric-row asset-invest-form-row">
                  <span className="asset-metric-title--alphabet asset-invest-form-metric-title">{profitRow.title}</span>
                  <span
                    className={`asset-money-wrap asset-profit-range-anim${
                      formValuesHidden || formCalcHidden ? ' is-hidden' : ''
                    }`}
                  ...
                  >
                    {profitRow.prefix ? (
                      <span className="asset-metric-inline-symbol--alphabet">{profitRow.prefix}</span>
                    ) : null}
            ...
            <div className="asset-invest-form-controls asset-invest-form-controls--alphabet">
              <div className="asset-invest-form-field">
                ...
                <div className="asset-invest-form-field-control">
                  <input
                    className="asset-invest-input asset-invest-input--alphabet"
                    type="text"
                    inputMode="decimal"
                    pattern="^[0-9]*\\.?[0-9]*$"
                    value={tokenAmount}
              ...
              <div className="asset-invest-form-field">
                <div className="asset-metric-row asset-invest-form-field-label">
                  <span className="asset-metric-title--alphabet">Date purchased</span>
                </div>
                <div className="asset-invest-form-field-control">
  ...
  return (
    <>
      <div className="asset-page-content asset-page-content--alphabet page-slide-down">
      <div
        className="asset-panel asset-panel--alphabet asset-header-panel asset-section-slide"
        ref={headerPanelRef}
      >
        <a
          className="asset-title-badge asset-title-badge--alphabet asset-title-badge--section"
          href="https://abc.xyz/"
          target="_blank"
          rel="noreferrer"
        >
        ...
        <div
          className="asset-panel asset-panel--alphabet asset-price-chart-row asset-price-chart-row--combined"
          style={{ overflow: 'visible' }}
      >
          <div
            className="asset-price-panel asset-price-panel--alphabet asset-section-slide"
            style={{
              padding: '30px',
      ...
      >
            <div className="asset-metric-row">
              <span className="asset-metric-title--alphabet">Price:</span>
              <span className="asset-metric-value-wrap">
                {!headerNumbersVisible && (
                  <span className={`asset-number-loader asset-number-loader--alphabet asset-number-loader--overlay${shimmersFading ? ' is-hidden' : ''}`} />
                )}
                <span className={`asset-metric-symbol--alphabet asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`}>$</span>
            ...
            <div className="asset-metric-row">
              <span className="asset-metric-title--alphabet">Market Cap:</span>
              <span className="asset-metric-value-wrap">
                {!headerNumbersVisible && (
                  <span className={`asset-number-loader asset-number-loader--alphabet asset-number-loader--wide asset-number-loader--overlay${shimmersFading ? ' is-hidden' : ''}`} />
                )}
                <span className={`asset-metric-symbol--alphabet asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`}>$</span>
                <span className="asset-header-switch-fade" style={realityFadeStyle}>
                  <span className={`asset-metric-value asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`}>
            ...
            <div className="asset-metric-row">
              <span className="asset-metric-value-wrap">
                {!headerNumbersVisible && (
                  <span className={`asset-number-loader asset-number-loader--alphabet asset-number-loader--narrow asset-number-loader--overlay${shimmersFading ? ' is-hidden' : ''}`} />
                )}
              {percentageIncrease > 0 ? (
                <span className={`asset-metric-trend-icon asset-metric-trend-icon--alphabet asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`} aria-hidden="true" />
              ) : (
                <span
                  className={`asset-metric-trend-icon asset-metric-trend-icon--down asset-metric-trend-icon--alphabet asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`}
                  aria-hidden="true"
                />
              )}
              <span
              ...
              <span
                className={`asset-metric-symbol--alphabet asset-metric-percent-symbol--alphabet asset-mount-fade-2s${
            ...
            <div
              className="asset-panel asset-panel--alphabet asset-section-slide asset-market-controls"
            >
              <div className="asset-market-controls-header">
                <div className="asset-profit-summary asset-profit-summary--alphabet" style={{ marginBottom: 0 }}>
                  <div className="asset-metric-inline-row">
                    {(() => {
                      ...
                      return (
                        <>
                          <span className="asset-metric-inline-title--alphabet asset-market-status-title">
                            {label}:
                          </span>{' '}
                          <span
                ...
                {chartRanges.map((range) => {
                  ...
                  return (
                    <button
                      key={range.label}
                      type="button"
                      className={`asset-range-button asset-range-button--alphabet${isActive ? ' is-active' : ''}`}
          ...
          <div
              className="asset-panel asset-panel--alphabet asset-section-slide asset-chart-panel asset-chart-panel--alphabet"
            style={{
              padding: '0px',
                position: 'relative',
          ...
          >
            {chartHoverPoint != null && displayPoint && (
                <div className="asset-chart-date-badge asset-chart-date-badge--alphabet">
                <span className="asset-metric-inline-title--alphabet">Date:</span>{' '}
              ...
              <div className={`asset-chart-loader${chartReady && !forceChartLoader ? ' is-hidden' : ''}`}>
                <div className="asset-chart-grid-shimmer asset-chart-grid-shimmer--alphabet">
              ...
              <div
                ...
                style={{
                  ...
                  zIndex: 0,
                  backgroundImage:
                    'repeating-linear-gradient(to right, rgba(66, 133, 244, 0.1) 0px, rgba(66, 133, 244, 0.1) 1px, transparent 1px, transparent 30px), repeating-linear-gradient(to bottom, rgba(66, 133, 244, 0.1) 0px, rgba(66, 133, 244, 0.1) 1px, transparent 1px, transparent 30px)',
                }}
              />
              <div
            ...
            <AlphabetChart
              history={chartHistoryForLine || []}
                  color="rgba(37, 99, 200, 0.5)"
                  activeColor="rgba(37, 99, 200, 0.6)"
                  markerColor="rgba(37, 99, 200, 1)"
                  gridColor="transparent"
                  gridSpacing={30}
                  height={chartCanvasHeight}
                  interactiveHeight={chartPanelHeight}
                  canvasOffsetTop={chartTopPadding}
                  backgroundColor="rgba(37, 99, 200, 0.16)"
                  markerShadow="-5px 0 14px rgba(37, 99, 200, 0.26), 0 7px 10px rgba(37, 99, 200, 0.18)"
                  animateOn={false}
                  animateDelayMs={0}
          ...
          <div className="asset-panel asset-panel--alphabet asset-reality-toggle-shell">
            <div className="asset-reality-toggle-row asset-reality-toggle-row--alphabet">
      ...
      <div
        className={`asset-panel asset-panel--alphabet asset-portfolio-center asset-section-slide${
      ...
      >
        {!hasInvestmentsUI && !showInitialFetchLoader ? (
          <>
            ...
            >
              ...
              >
                <button
                  className="asset-action-button asset-action-button--alphabet asset-action-button--invest-add asset-action-button--add-investments"
          ...
          <>
            ...
            <div
              ...
              className={`asset-slide-panel${isClearingInvestments ? ' asset-slide-panel--clearing asset-slide-panel--clearing-alphabet' : ''}`}
              style={{
            ...
            >
              <div ref={investmentsWholeContentRef}>
                ...
                <div
                  className={`asset-portfolio-summary-box asset-portfolio-summary-box--alphabet${
              ...
              <div
                className="asset-panel asset-panel--alphabet asset-profit-block asset-slide-in"
                style={{ 
                  padding: '20px 20px 20px', marginBottom: '10px', width: '92%', marginLeft: 'auto', marginRight: 'auto' }}
              >
                <div className="asset-profit-summary asset-profit-summary--alphabet">
                  <div className="asset-metric-inline-row">
                {(() => {
                          ...
                          >
                            <span ref={profitInlineAnimRef} className="asset-profit-range-anim">
                              ...
                              >
                                ...
                                >
                                  <span className="asset-metric-symbol--alphabet">
                                    {isProfit ? '+$' : '-$'}
                                  </span>
              ...
              <div className="asset-portfolio-actions asset-portfolio-actions--add">
                <button
                  className={`asset-action-button asset-action-button--alphabet asset-action-button--invest-add${
          ...
          <div className="asset-empty-addinvest">
            ...
            >
              Add Investments
                ...
                >
                  <button
                    className={`asset-action-button asset-action-button--alphabet asset-action-button--invest-show${
                ...
                {showInvestmentsList && (
                  ...
                  >
                    ...
                    <div
                      className={`asset-investments-wrap asset-investments-wrap--alphabet asset-slide-panel${
                        ...
                        return (
                          <React.Fragment key={investmentId}>
                            ...
                            >
                              ...
                              <div
                                className={`asset-panel asset-panel--alphabet${isPendingDelete ? ' is-pending-delete' : ''}${
                              ...
                              >
                                <div
                                  ...
                                  style={{
                                    ...
                                    borderTopColor: 'rgba(66, 133, 244, 0.5)',
                                  }}
                                />
                              </div>
                              <div className="asset-investment-metrics">
                                  ...
                                  <div className="asset-metric-row asset-money-row" style={{ justifyContent: 'center' }}>
                                    {(() => {
                                      ...
                                      return (
                                        <>
                                          <span className="asset-metric-title--alphabet">{title}</span>
                                          <span className="asset-money-wrap">
                                            <span className="asset-metric-inline-symbol--alphabet">{prefix}</span>
                                            <span className="asset-metric-value">
                                  ...
                                  <button
                                    type="button"
                                    className="asset-range-button asset-range-button--alphabet asset-delete-button asset-investment-delete-button"
        ...
        {shouldRenderAddForm && (
          ...
          >
            <div className="asset-portfolio-summary-box asset-portfolio-summary-box--alphabet">
              <div
