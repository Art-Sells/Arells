...
export const ALIEN_RACE_UPDATES_CATALOG: AlienRaceUpdatesDayCatalog[] = [
  {
    ...
    files: [
      ...
      'TBARS1E1W4(480p).mp4',
      'TBARS1E1W4(720p).mp4',
      'TBARS1E1W4(1080p).mp4',
    ],
  },
  {
    folder: '09.18.26',
    files: [
      'TBARS1E1W3(preview).jpg',
      'TBARS1E1W3(480p).mp4',
      'TBARS1E1W3(720p).mp4',
      'TBARS1E1W3(1080p).mp4',
    ],
  },
  {
    folder: '09.13.26',
    files: [
      'TBARS1E1W2(preview).jpg',
      'TBARS1E1W2(480p).mp4',
      'TBARS1E1W2(720p).mp4',
      'TBARS1E1W2(1080p).mp4',
    ],
  },
  {
    folder: '09.09.26',
    files: [
      'SneakPeak4Preview.jpg',
      'SneakPeek4(480p).mp4',
      'SneakPeek4(720p).mp4',
      'SneakPeek4(1080p).mp4',
    ],
  },
  {
    folder: '08.31.26',
