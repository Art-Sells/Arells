...
const SolanaPageClient: React.FC = () => {
  ...
  return (
    <div className="asset-page asset-page--solana" ref={pageRef}>
      <header className="asset-header asset-header--solana" />
      {showLoading && !showSessionResetOverlay && (
        <div
          className={`asset-loader-overlay asset-loader-overlay--solana${fadeOut ? ' asset-loader-overlay-fade' : ''}`}
        >
          <div
            ref={loaderToggleShellRef}
            className="asset-reality-toggle-shell asset-reality-toggle-shell--loader asset-loader-toggle-shell asset-loader-toggle-shell--solana"
          >
      ...
      {showSessionResetOverlay && (
        <div
          className={`asset-loader-overlay asset-loader-overlay--solana asset-session-reset-overlay${
            showSessionResetFade ? ' asset-loader-overlay-fade' : ''
          }${sessionResetVisible ? ' is-visible' : ''}`}
        >
          <div className="asset-session-reset-modal">
            <div className="asset-session-reset-text asset-session-reset-text--title asset-metric-title--solana">
              Resetting Investments
            </div>
            <div className="asset-session-reset-spinner-wrap asset-profit-summary asset-profit-summary--solana">
            ...
            <div className="asset-session-reset-text asset-session-reset-text--subtitle asset-metric-title--solana">
              Sign In to Save
            </div>
          </div>
        </div>
      ...
      >
        {!!email && (
          <Link
            href="/my-investments"
            className="asset-action-button asset-action-button--solana asset-action-button--invest-show asset-footer-about-button"
          >
        ...
        <Link
          href="/"
          className="asset-action-button asset-action-button--solana asset-action-button--invest-show asset-view-more-assets asset-view-more-assets--footer asset-footer-viewmore"
        >
        ...
        <div className="asset-footer-share-sentence">share this<br />if you believe<br />Solana<br />should never<br />lose value</div>
      </footer>
    </div>
  );
};
