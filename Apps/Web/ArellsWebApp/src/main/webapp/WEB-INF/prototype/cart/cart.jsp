...
<body>
	...
	<div id="cart-full-cart" style="display: none;">
		...
		<div id="container-cart">
			  	...
			  	<!-- Change below link after test -->
			  		<a href="/prototype-blue-orange" target="_self" id="photo-link-cart">
			  	...
			  	<!-- Change below link after test -->
			  		<a href="/prototype-beach-houses" target="_self" id="photo-link-cart">
			     ...
			     <!-- Change below link after test -->
			  		<a href="/prototype-colour-glass" target="_self" id="photo-link-cart">
				...
				<!-- Change below link after test -->
			  		<a href="/prototype-layers" target="_self" id="photo-link-cart">
			  	...
			  	<!-- Change below link after test -->
		  			<a href="/prototype-succinct-drop" target="_self" id="photo-link-cart">
				...
				<!-- Change below link after test -->
			  		<a href="/prototype-paint-rain" target="_self" id="photo-link-cart">
