            ...
            <div className="asset-invest-form-metrics-panel asset-invest-form-metrics-panel--bch">
              <div className="asset-invest-form-metrics">
                <div className="asset-metric-row asset-invest-form-row">
                  <span className="asset-metric-title--bch asset-invest-form-metric-title life-force-metric-label">Purchased <LifeForceInfoBadge assetName={ASSET.displayName} /> Value</span>
                  <span
                ...
                <div className="asset-metric-row asset-invest-form-row">
                  <span className="asset-metric-title--bch asset-invest-form-metric-title life-force-metric-label">Current <LifeForceInfoBadge assetName={ASSET.displayName} /> Value</span>
                  <span
            ...
            <div className="asset-invest-form-controls asset-invest-form-controls--bch">
              <div className="asset-invest-form-field">
                <div className="asset-metric-row asset-invest-form-field-label">
                  <span className="asset-metric-title--bch life-force-metric-label">{ASSET.ticker} <LifeForceInfoBadge assetName={ASSET.displayName} /> amount</span>
                </div>
          ...
          <>
            ...
            >
              <div ref={investmentsWholeContentRef}>
                {showInvestmentsHeader && (
                  <h2 className="asset-investments-header">
                    <span className="asset-portfolio-title-muted">my bitcoin cash alien</span>
                  </h2>
                )}
                <div
              ...
              <div className="asset-metric-row asset-money-row" style={{ marginBottom: '8px', justifyContent: 'center' }}>
                <span className="asset-metric-title--bch life-force-metric-label" style={{ marginTop: 30 }}>Purchased <LifeForceInfoBadge assetName={ASSET.displayName} /> Value</span>
                <div
              ...
              <div className="asset-metric-row asset-money-row" style={{ marginBottom: '8px', justifyContent: 'center' }}>
                <span className="asset-metric-title--bch life-force-metric-label">Current <LifeForceInfoBadge assetName={ASSET.displayName} /> Value</span>
                <div
                  ref={currentValueRef}
                  style={{
                        ...
                        return (
                          ...
                          >
                            <span ref={profitInlineAnimRef} className="asset-profit-range-anim">
                              <span className="asset-metric-inline-title--bch life-force-metric-label">
                            ...
                            >
                              ...
                              <div className="asset-investment-metrics">
                                  <div className="asset-metric-row asset-money-row" style={{ justifyContent: 'center' }}>
                                    <span className="asset-metric-title--bch life-force-metric-label" style={{ marginTop: 20 }}>Purchased <LifeForceInfoBadge assetName={ASSET.displayName} /> Value</span>
