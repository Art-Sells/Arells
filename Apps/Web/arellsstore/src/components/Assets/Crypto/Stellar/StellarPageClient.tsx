...
const StellarPageClient: React.FC = () => {
  ...
  /** Survives `<Stellar key={sessionResetKey} />` remounts so session-clear-on-mount runs once per page visit. */
  ...
  return (
    <div className={`asset-page asset-page--${ASSET.cssModifier}`} ref={pageRef}>
            ...
            <div className={`asset-session-reset-spinner-wrap asset-profit-summary asset-profit-summary--${ASSET.cssModifier}`}>
              <div className="asset-session-reset-spinner" aria-hidden="true">
                <div
                  ...
                  style={{ borderColor: 'rgba(0, 0, 0, 0.2)', borderTopColor: 'rgba(17, 17, 17, 0.55)' }}
                />
              </div>
            </div>
      ...
      <Stellar key={`session-reset-${sessionResetKeyValue}`} sessionMountClearGuardRef={sessionMountClearGuardRef} />
...
export default StellarPageClient;
