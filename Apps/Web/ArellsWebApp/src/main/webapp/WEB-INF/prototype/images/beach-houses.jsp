...
<body>
	...
	<!-- Change below link after test -->
		<a id="icon-link-beach-houses" href="/">
		...
		<a id="cart-link-connected-beach-houses" href="/prototype-cart" style="display: none;">
			<img id="cart-icon-beach-houses" src="/icons&images/prototype/shopping-cart-empty.png"/>
		</a>
		<a id="cart-link-full-beach-houses" href="/prototype-cart" style="display: none;">
