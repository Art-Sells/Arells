...
import DogeChart from './DogeChart';
...
const ASSET = CRYPTO_ASSET_BY_ID.doge;

const PREVIEW_SKIP_SESSION_DELETES = false;


type VavityDogeProps = {
  sessionMountClearGuardRef: React.MutableRefObject<boolean>;
};

const VavityDoge: React.FC<VavityDogeProps> = ({ sessionMountClearGuardRef }) => {
  ...
  useEffect(() => {
    ...
    const bg = 'rgba(194, 166, 51, 0.075)';
    ...
    const loadRangePrice = async () => {
      ...
      try {
        const [solidResp, liquidResp] = await Promise.all([
          axios.get('/api/assets/crypto/doge/dogeVapaHistoricalPrice', { params: { date: isoDate, mode: 'solid' } }),
          axios.get('/api/assets/crypto/doge/dogeVapaHistoricalPrice', { params: { date: isoDate, mode: 'liquid' } }),
        ]);
  ...
  useEffect(() => {
    ...
    const loadMock = async () => {
      try {
        const resp = await axios.get('/api/assets/crypto/doge/dogeMockPortfolio');
  ...
  useEffect(() => {
    ...
    const loadHistorical = async () => {
      ...
      try {
        const [solidResp, liquidResp] = await Promise.all([
          axios.get('/api/assets/crypto/doge/dogeVapaHistoricalPrice', {
      ...
      <div className="asset-invest-form">
        <div className="asset-submit-form">
          <div className="asset-metric-row asset-invest-form-heading">
            <span className="asset-metric-title--doge" style={{ fontWeight: 800 }}>
              {label}
            </span>
          </div>

          <div className="asset-invest-form-body asset-invest-form-body--doge">
            <div className="asset-invest-form-metrics-panel asset-invest-form-metrics-panel--doge">
              <div className="asset-invest-form-metrics">
                <div className="asset-metric-row asset-invest-form-row">
                  <span className="asset-metric-title--doge asset-invest-form-metric-title life-force-metric-label">Purchased <LifeForceInfoBadge assetName={ASSET.displayName} /> Value</span>
                  <span
                  ...
                  >
                    <span className="asset-metric-symbol--doge">$</span>
                ...
                <div className="asset-metric-row asset-invest-form-row">
                  <span className="asset-metric-title--doge asset-invest-form-metric-title life-force-metric-label">Current <LifeForceInfoBadge assetName={ASSET.displayName} /> Value</span>
                  <span
                ...
                <div className="asset-metric-row asset-invest-form-row">
                  <span className="asset-metric-title--doge asset-invest-form-metric-title">{profitRow.title}</span>
                  <span
                    className={`asset-money-wrap asset-profit-range-anim${
                      formValuesHidden || formCalcHidden ? ' is-hidden' : ''
                    }`}
                  ...
                  >
                    {profitRow.prefix ? (
                      <span className="asset-metric-inline-symbol--doge">{profitRow.prefix}</span>
                    ) : null}
            ...
            <div className="asset-invest-form-controls asset-invest-form-controls--doge">
              <div className="asset-invest-form-field">
                <div className="asset-metric-row asset-invest-form-field-label">
                  <span className="asset-metric-title--doge life-force-metric-label">{ASSET.ticker} <LifeForceInfoBadge assetName={ASSET.displayName} /> amount</span>
                </div>
                <div className="asset-invest-form-field-control">
                  <input
                    className="asset-invest-input asset-invest-input--doge"
                    type="text"
                    inputMode="decimal"
                    pattern="^[0-9]*\\.?[0-9]*$"
                    value={tokenAmount}
              ...
              <div className="asset-invest-form-field">
                <div className="asset-metric-row asset-invest-form-field-label">
                  <span className="asset-metric-title--doge">Date purchased</span>
                </div>
                <div className="asset-invest-form-field-control">
  ...
  return (
    <>
      <div className="asset-page-content asset-page-content--doge page-slide-down">
      <div
        className="asset-panel asset-panel--doge asset-header-panel asset-section-slide"
        ref={headerPanelRef}
      >
        <a
          className="asset-title-badge asset-title-badge--doge asset-title-badge--section"
        ...
        <div
          className="asset-panel asset-panel--doge asset-price-chart-row asset-price-chart-row--combined"
          style={{ overflow: 'visible' }}
      >
          <div
            className="asset-price-panel asset-price-panel--doge asset-section-slide"
            style={{
              padding: '30px',
      ...
      >
            <div className="asset-metric-row">
              <span className="asset-metric-title--doge">Price:</span>
              <span className="asset-metric-value-wrap">
                {!headerNumbersVisible && (
                  <span className={`asset-number-loader asset-number-loader--doge asset-number-loader--overlay${shimmersFading ? ' is-hidden' : ''}`} />
                )}
                <span className={`asset-metric-symbol--doge asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`}>$</span>
            ...
            <div className="asset-metric-row">
              <span className="asset-metric-title--doge">Market Cap:</span>
              <span className="asset-metric-value-wrap">
                {!headerNumbersVisible && (
                  <span className={`asset-number-loader asset-number-loader--doge asset-number-loader--wide asset-number-loader--overlay${shimmersFading ? ' is-hidden' : ''}`} />
                )}
                <span className={`asset-metric-symbol--doge asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`}>$</span>
                <span className="asset-header-switch-fade" style={realityFadeStyle}>
                  <span className={`asset-metric-value asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`}>
            ...
            <div className="asset-metric-row">
              <span className="asset-metric-value-wrap">
                {!headerNumbersVisible && (
                  <span className={`asset-number-loader asset-number-loader--doge asset-number-loader--narrow asset-number-loader--overlay${shimmersFading ? ' is-hidden' : ''}`} />
                )}
              {percentageIncrease > 0 ? (
                <span className={`asset-metric-trend-icon asset-metric-trend-icon--doge asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`} aria-hidden="true" />
              ) : (
                <span
                  className={`asset-metric-trend-icon asset-metric-trend-icon--down asset-metric-trend-icon--doge asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`}
                  aria-hidden="true"
                />
              )}
              <span
              ...
              <span
                className={`asset-metric-symbol--doge asset-metric-percent-symbol--doge asset-mount-fade-2s${
            ...
            <div
              className="asset-panel asset-panel--doge asset-section-slide asset-market-controls"
            >
              <div className="asset-market-controls-header">
                <div className="asset-profit-summary asset-profit-summary--doge" style={{ marginBottom: 0 }}>
                  <div className="asset-metric-inline-row">
                    {(() => {
                      ...
                      return (
                        <>
                          <span className="asset-metric-inline-title--doge asset-market-status-title">
                            {label}:
                          </span>{' '}
                          <span
                ...
                {chartRanges.map((range) => {
                  ...
                  return (
                    <button
                      key={range.label}
                      type="button"
                      className={`asset-range-button asset-range-button--doge${isActive ? ' is-active' : ''}`}
                      disabled={isActive}
                      onClick={() => {
                        if (isActive) return;
          ...
          <div
              className="asset-panel asset-panel--doge asset-section-slide asset-chart-panel asset-chart-panel--doge"
            style={{
              padding: '0px',
                position: 'relative',
          ...
          >
            {chartHoverPoint != null && displayPoint && (
                <div className="asset-chart-date-badge asset-chart-date-badge--doge">
                <span className="asset-metric-inline-title--doge">Date:</span>{' '}
              ...
              <div className={`asset-chart-loader${chartReady && !forceChartLoader ? ' is-hidden' : ''}`}>
                <div className="asset-chart-grid-shimmer asset-chart-grid-shimmer--doge">
              ...
              <div
                ...
                style={{
                  ...
                  zIndex: 0,
                  backgroundImage:
                    'repeating-linear-gradient(to right, rgba(194, 166, 51, 0.1) 0px, rgba(194, 166, 51, 0.1) 1px, transparent 1px, transparent 30px), repeating-linear-gradient(to bottom, rgba(194, 166, 51, 0.1) 0px, rgba(194, 166, 51, 0.1) 1px, transparent 1px, transparent 30px)',
                }}
              />
              <div
            ...
            <DogeChart
              history={chartHistoryForLine || []}
                  color="rgba(194, 166, 51, 0.5)"
                  activeColor="rgba(194, 166, 51, 0.6)"
                  markerColor="rgba(194, 166, 51, 1)"
                  gridColor="transparent"
                  gridSpacing={30}
                  height={chartCanvasHeight}
                  interactiveHeight={chartPanelHeight}
                  canvasOffsetTop={chartTopPadding}
                  backgroundColor="rgba(194, 166, 51, 0.16)"
                  markerShadow="-5px 0 14px rgba(194, 166, 51, 0.26), 0 7px 10px rgba(194, 166, 51, 0.18)"
                  animateOn={false}
                  animateDelayMs={0}
          ...
          <div className="asset-panel asset-panel--doge asset-reality-toggle-shell">
            <div className="asset-reality-toggle-row asset-reality-toggle-row--doge">
      ...
      <div
        className={`asset-panel asset-panel--doge asset-portfolio-center asset-section-slide${
      ...
      >
        {!hasInvestmentsUI && !showInitialFetchLoader ? (
          <>
            ...
            >
              ...
              >
                <button
                  className="asset-action-button asset-action-button--doge asset-action-button--invest-add asset-action-button--add-investments"
          ...
          <>
            ...
            <div
              ...
              className={`asset-slide-panel${isClearingInvestments ? ' asset-slide-panel--clearing asset-slide-panel--clearing-doge' : ''}`}
              style={{
            ...
            >
              <div ref={investmentsWholeContentRef}>
                {showInvestmentsHeader && (
                  <h2 className="asset-investments-header">
                    <span className="asset-portfolio-title-muted">my doge alien</span>
                  </h2>
                )}
                <div
                  className={`asset-portfolio-summary-box asset-portfolio-summary-box--doge${
              ...
              <div className="asset-metric-row asset-money-row" style={{ marginBottom: '8px', justifyContent: 'center' }}>
                <span className="asset-metric-title--doge life-force-metric-label" style={{ marginTop: 30 }}>Purchased <LifeForceInfoBadge assetName={ASSET.displayName} /> Value</span>
                <div
              ...
              <div className="asset-metric-row asset-money-row" style={{ marginBottom: '8px', justifyContent: 'center' }}>
                <span className="asset-metric-title--doge life-force-metric-label">Current <LifeForceInfoBadge assetName={ASSET.displayName} /> Value</span>
                <div
                  ref={currentValueRef}
                  style={{
              ...
              <div
                className="asset-panel asset-panel--doge asset-profit-block asset-slide-in"
                style={{ 
                  padding: '20px 20px 20px', marginBottom: '10px', width: '92%', marginLeft: 'auto', marginRight: 'auto' }}
              >
                <div className="asset-profit-summary asset-profit-summary--doge">
                  <div className="asset-metric-inline-row">
                {(() => {
                        ...
                        return (
                          ...
                          >
                            <span ref={profitInlineAnimRef} className="asset-profit-range-anim">
                              <span className="asset-metric-inline-title--doge life-force-metric-label">
                              ...
                              >
                                ...
                                >
                                  <span className="asset-metric-symbol--doge">
                                    {isProfit ? '+$' : '-$'}
                                  </span>
              ...
              <div className="asset-portfolio-actions asset-portfolio-actions--add">
                <button
                  className={`asset-action-button asset-action-button--doge asset-action-button--invest-add${
              ...
              {showAddMoreForm && (
                ...
                >
                  <div ref={addMoreFormBoxRef} className="asset-slide-panel-inner">
                    <div className="asset-invest-form-box asset-invest-form-box--doge">
                      {renderAddForm(
                        'Add more life force',
                        closeAddMoreForm,
                        'asset-action-button asset-action-button--doge'
                      )}
          ...
          <div className="asset-empty-addinvest">
            ...
            >
              Add My Alien
                ...
                >
                  <button
                    className={`asset-action-button asset-action-button--doge asset-action-button--invest-show${
                ...
                {showInvestmentsList && (
                  ...
                  >
                    ...
                    <div
                      className={`asset-investments-wrap asset-investments-wrap--doge asset-slide-panel${
                        ...
                        return (
                          <React.Fragment key={investmentId}>
                            ...
                            >
                              ...
                              <div
                                className={`asset-panel asset-panel--doge${isPendingDelete ? ' is-pending-delete' : ''}${
                              ...
                              >
                                <div
                                  ...
                                  style={{
                                    ...
                                    borderTopColor: 'rgba(194, 166, 51, 0.5)',
                                  }}
                                />
                              </div>
                              <div className="asset-investment-metrics">
                                  <div className="asset-metric-row asset-money-row" style={{ justifyContent: 'center' }}>
                                    <span className="asset-metric-title--doge life-force-metric-label" style={{ marginTop: 20 }}>Purchased <LifeForceInfoBadge assetName={ASSET.displayName} /> Value</span>
                                  ...
                                  <div className="asset-metric-row asset-money-row" style={{ justifyContent: 'center' }}>
                                    {(() => {
                                      ...
                                      return (
                                        <>
                                          <span className="asset-metric-title--doge">{title}</span>
                                          <span className="asset-money-wrap">
                                            <span className="asset-metric-inline-symbol--doge">{prefix}</span>
                                            <span className="asset-metric-value">
                                  ...
                                  <button
                                    type="button"
                                    className="asset-range-button asset-range-button--doge asset-delete-button asset-investment-delete-button"
        ...
        {shouldRenderAddForm && (
          ...
          >
            <div className="asset-portfolio-summary-box asset-portfolio-summary-box--doge">
              <div
