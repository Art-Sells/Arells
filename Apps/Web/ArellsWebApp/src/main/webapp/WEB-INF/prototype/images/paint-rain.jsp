...
<!-- Below information for social media sharing and search-engine/browser optimization -->		
		...
		<meta name="description" content="Prototype Paint Rain">
		...
		<meta property="og:description" content="Prototype Paint Rain">
		...
		<meta name="twitter:description" content="Prototype Paint Rain">
...
<body>
	...
	<!-- Change below link after test -->
		<a id="icon-link-paint-rain" href="/">
		...
		<a id="cart-link-connected-paint-rain" href="/prototype-cart" style="display: none;">
			<img id="cart-icon-paint-rain" src="/icons&images/prototype/shopping-cart-empty.png"/>
		</a>
		<a id="cart-link-full-paint-rain" href="/prototype-cart" style="display: none;">
