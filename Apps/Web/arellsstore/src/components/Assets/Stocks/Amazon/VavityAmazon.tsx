...
const ASSET = STOCK_ASSET_BY_ID.amazon;

const PREVIEW_SKIP_SESSION_DELETES = false;


type VavityAmazonProps = {
  sessionMountClearGuardRef: React.MutableRefObject<boolean>;
};

const VavityAmazon: React.FC<VavityAmazonProps> = ({ sessionMountClearGuardRef }) => {
    ...
    const loadRangePrice = async () => {
      ...
      try {
        const [solidResp, liquidResp] = await Promise.all([
          axios.get('/api/assets/stocks/amazon/amazonVapaHistoricalPrice', { params: { date: isoDate, mode: 'solid' } }),
          axios.get('/api/assets/stocks/amazon/amazonVapaHistoricalPrice', { params: { date: isoDate, mode: 'liquid' } }),
        ]);
  ...
  useEffect(() => {
    ...
    const loadMock = async () => {
      try {
        const resp = await axios.get('/api/assets/stocks/amazon/amazonMockPortfolio');
  ...
  useEffect(() => {
    ...
    const loadHistorical = async () => {
      ...
      try {
        const [solidResp, liquidResp] = await Promise.all([
          axios.get('/api/assets/stocks/amazon/amazonVapaHistoricalPrice', {
      ...
      <div className="asset-invest-form">
        <div className="asset-submit-form">
          <div className="asset-metric-row asset-invest-form-heading">
            <span className="asset-metric-title--amazon" style={{ fontWeight: 800 }}>
              {label}
            </span>
          </div>

          <div className="asset-invest-form-body asset-invest-form-body--amazon">
            <div className="asset-invest-form-metrics-panel asset-invest-form-metrics-panel--amazon">
              <div className="asset-invest-form-metrics">
                <div className="asset-metric-row asset-invest-form-row">
                  <span className="asset-metric-title--amazon asset-invest-form-metric-title life-force-metric-label">Purchased <LifeForceInfoBadge assetName={ASSET.displayName} /> Value</span>
                  <span
                  ...
                  >
                    <span className="asset-metric-symbol--amazon">$</span>
                ...
                <div className="asset-metric-row asset-invest-form-row">
                  <span className="asset-metric-title--amazon asset-invest-form-metric-title life-force-metric-label">Current <LifeForceInfoBadge assetName={ASSET.displayName} /> Value</span>
                  <span
                ...
                <div className="asset-metric-row asset-invest-form-row">
                  <span className="asset-metric-title--amazon asset-invest-form-metric-title">{profitRow.title}</span>
                  <span
                    className={`asset-money-wrap asset-profit-range-anim${
                      formValuesHidden || formCalcHidden ? ' is-hidden' : ''
                    }`}
                  ...
                  >
                    {profitRow.prefix ? (
                      <span className="asset-metric-inline-symbol--amazon">{profitRow.prefix}</span>
                    ) : null}
            ...
            <div className="asset-invest-form-controls asset-invest-form-controls--amazon">
              <div className="asset-invest-form-field">
                <div className="asset-metric-row asset-invest-form-field-label">
                  <span className="asset-metric-title--amazon life-force-metric-label">{ASSET.ticker} <LifeForceInfoBadge assetName={ASSET.displayName} /> amount</span>
                </div>
                <div className="asset-invest-form-field-control">
                  <input
                    className="asset-invest-input asset-invest-input--amazon"
                    type="text"
                    inputMode="decimal"
                    pattern="^[0-9]*\\.?[0-9]*$"
                    value={tokenAmount}
              ...
              <div className="asset-invest-form-field">
                <div className="asset-metric-row asset-invest-form-field-label">
                  <span className="asset-metric-title--amazon">Date purchased</span>
                </div>
                <div className="asset-invest-form-field-control">
  ...
  return (
    <>
      <div className="asset-page-content asset-page-content--amazon page-slide-down">
      <div
        className="asset-panel asset-panel--amazon asset-header-panel asset-section-slide"
        ref={headerPanelRef}
      >
        <a
          className="asset-title-badge asset-title-badge--amazon asset-title-badge--section"
        ...
        <div
          className="asset-panel asset-panel--amazon asset-price-chart-row asset-price-chart-row--combined"
          style={{ overflow: 'visible' }}
      >
          <div
            className="asset-price-panel asset-price-panel--amazon asset-section-slide"
            style={{
              padding: '30px',
      ...
      >
            <div className="asset-metric-row">
              <span className="asset-metric-title--amazon">Price:</span>
              <span className="asset-metric-value-wrap">
                {!headerNumbersVisible && (
                  <span className={`asset-number-loader asset-number-loader--amazon asset-number-loader--overlay${shimmersFading ? ' is-hidden' : ''}`} />
                )}
                <span className={`asset-metric-symbol--amazon asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`}>$</span>
            ...
            <div className="asset-metric-row">
              <span className="asset-metric-title--amazon">Market Cap:</span>
              <span className="asset-metric-value-wrap">
                {!headerNumbersVisible && (
                  <span className={`asset-number-loader asset-number-loader--amazon asset-number-loader--wide asset-number-loader--overlay${shimmersFading ? ' is-hidden' : ''}`} />
                )}
                <span className={`asset-metric-symbol--amazon asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`}>$</span>
                <span className="asset-header-switch-fade" style={realityFadeStyle}>
                  <span className={`asset-metric-value asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`}>
            ...
            <div className="asset-metric-row">
              <span className="asset-metric-value-wrap">
                {!headerNumbersVisible && (
                  <span className={`asset-number-loader asset-number-loader--amazon asset-number-loader--narrow asset-number-loader--overlay${shimmersFading ? ' is-hidden' : ''}`} />
                )}
              {percentageIncrease > 0 ? (
                <span className={`asset-metric-trend-icon asset-metric-trend-icon--amazon asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`} aria-hidden="true" />
              ) : (
                <span
                  className={`asset-metric-trend-icon asset-metric-trend-icon--down asset-metric-trend-icon--amazon asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`}
                  aria-hidden="true"
                />
              )}
              <span
              ...
              <span
                className={`asset-metric-symbol--amazon asset-metric-percent-symbol--amazon asset-mount-fade-2s${
            ...
            <div
              className="asset-panel asset-panel--amazon asset-section-slide asset-market-controls"
            >
              <div className="asset-market-controls-header">
                <div className="asset-profit-summary asset-profit-summary--amazon" style={{ marginBottom: 0 }}>
                  <div className="asset-metric-inline-row">
                    {(() => {
                      ...
                      return (
                        <>
                          <span className="asset-metric-inline-title--amazon asset-market-status-title">
                            {label}:
                          </span>{' '}
                          <span
                ...
                {chartRanges.map((range) => {
                  ...
                  return (
                    <button
                      key={range.label}
                      type="button"
                      className={`asset-range-button asset-range-button--amazon${isActive ? ' is-active' : ''}`}
          ...
          <div
              className="asset-panel asset-panel--amazon asset-section-slide asset-chart-panel asset-chart-panel--amazon"
            style={{
              padding: '0px',
                position: 'relative',
          ...
          >
            {chartHoverPoint != null && displayPoint && (
                <div className="asset-chart-date-badge asset-chart-date-badge--amazon">
                <span className="asset-metric-inline-title--amazon">Date:</span>{' '}
              ...
              <div className={`asset-chart-loader${chartReady && !forceChartLoader ? ' is-hidden' : ''}`}>
                <div className="asset-chart-grid-shimmer asset-chart-grid-shimmer--amazon">
              ...
              <div
                ...
                style={{
                  ...
                  zIndex: 0,
                  backgroundImage:
                    'repeating-linear-gradient(to right, rgba(255, 153, 0, 0.1) 0px, rgba(255, 153, 0, 0.1) 1px, transparent 1px, transparent 30px), repeating-linear-gradient(to bottom, rgba(255, 153, 0, 0.1) 0px, rgba(255, 153, 0, 0.1) 1px, transparent 1px, transparent 30px)',
                }}
              />
              <div
            ...
            <AmazonChart
              history={chartHistoryForLine || []}
                  ...
                  activeColor="rgba(255, 153, 0, 0.6)"
                  markerColor="rgba(255, 153, 0, 1)"
                  ...
                  markerShadow="-5px 0 14px rgba(255, 153, 0, 0.26), 0 7px 10px rgba(255, 153, 0, 0.18)"
                  animateOn={false}
                  animateDelayMs={0}
          ...
          <div className="asset-panel asset-panel--amazon asset-reality-toggle-shell">
            <div className="asset-reality-toggle-row asset-reality-toggle-row--amazon">
      ...
      <div
        className={`asset-panel asset-panel--amazon asset-portfolio-center asset-section-slide${
      ...
      >
        {!hasInvestmentsUI && !showInitialFetchLoader ? (
          <>
            ...
            >
              ...
              >
                <button
                  className="asset-action-button asset-action-button--amazon asset-action-button--invest-add asset-action-button--add-investments"
          ...
          <>
            ...
            <div
              ...
              className={`asset-slide-panel${isClearingInvestments ? ' asset-slide-panel--clearing asset-slide-panel--clearing-amazon' : ''}`}
              style={{
            ...
            >
              <div ref={investmentsWholeContentRef}>
                {showInvestmentsHeader && (
                  <h2 className="asset-investments-header">
                    <span className="asset-portfolio-title-muted">my amazon alien</span>
                  </h2>
                )}
                <div
                  className={`asset-portfolio-summary-box asset-portfolio-summary-box--amazon${
              ...
              <div className="asset-metric-row asset-money-row" style={{ marginBottom: '8px', justifyContent: 'center' }}>
                <span className="asset-metric-title--amazon life-force-metric-label" style={{ marginTop: 30 }}>Purchased <LifeForceInfoBadge assetName={ASSET.displayName} /> Value</span>
                <div
              ...
              <div className="asset-metric-row asset-money-row" style={{ marginBottom: '8px', justifyContent: 'center' }}>
                <span className="asset-metric-title--amazon life-force-metric-label">Current <LifeForceInfoBadge assetName={ASSET.displayName} /> Value</span>
                <div
                  ref={currentValueRef}
                  style={{
              ...
              <div
                className="asset-panel asset-panel--amazon asset-profit-block asset-slide-in"
                style={{ 
                  padding: '20px 20px 20px', marginBottom: '10px', width: '92%', marginLeft: 'auto', marginRight: 'auto' }}
              >
                <div className="asset-profit-summary asset-profit-summary--amazon">
                  <div className="asset-metric-inline-row">
                {(() => {
                        ...
                        return (
                          ...
                          >
                            <span ref={profitInlineAnimRef} className="asset-profit-range-anim">
                              <span className="asset-metric-inline-title--amazon life-force-metric-label">
                              ...
                              >
                                ...
                                >
                                  <span className="asset-metric-symbol--amazon">
                                    {isProfit ? '+$' : '-$'}
                                  </span>
              ...
              <div className="asset-portfolio-actions asset-portfolio-actions--add">
                <button
                  className={`asset-action-button asset-action-button--amazon asset-action-button--invest-add${
              ...
              {showAddMoreForm && (
                ...
                >
                  <div ref={addMoreFormBoxRef} className="asset-slide-panel-inner">
                    <div className="asset-invest-form-box asset-invest-form-box--amazon">
                      {renderAddForm(
                        'Add more life force',
                        closeAddMoreForm,
                        'asset-action-button asset-action-button--amazon'
                      )}
          ...
          <div className="asset-empty-addinvest">
            ...
            >
              Add My Alien
                ...
                >
                  <button
                    className={`asset-action-button asset-action-button--amazon asset-action-button--invest-show${
                ...
                {showInvestmentsList && (
                  ...
                  >
                    ...
                    <div
                      className={`asset-investments-wrap asset-investments-wrap--amazon asset-slide-panel${
                        ...
                        return (
                          <React.Fragment key={investmentId}>
                            ...
                            >
                              ...
                              <div
                                className={`asset-panel asset-panel--amazon${isPendingDelete ? ' is-pending-delete' : ''}${
                              ...
                              >
                                <div
                                  ...
                                  style={{
                                    borderColor: 'rgba(196, 110, 0, 0.2)',
                                    borderTopColor: 'rgba(196, 110, 0, 0.5)',
                                  }}
                                />
                              </div>
                              <div className="asset-investment-metrics">
                                  <div className="asset-metric-row asset-money-row" style={{ justifyContent: 'center' }}>
                                    <span className="asset-metric-title--amazon life-force-metric-label" style={{ marginTop: 20 }}>Purchased <LifeForceInfoBadge assetName={ASSET.displayName} /> Value</span>
                                  ...
                                  <div className="asset-metric-row asset-money-row" style={{ justifyContent: 'center' }}>
                                    {(() => {
                                      ...
                                      return (
                                        <>
                                          <span className="asset-metric-title--amazon">{title}</span>
                                          <span className="asset-money-wrap">
                                            <span className="asset-metric-inline-symbol--amazon">{prefix}</span>
                                            <span className="asset-metric-value">
                                  ...
                                  <button
                                    type="button"
                                    className="asset-range-button asset-range-button--amazon asset-delete-button asset-investment-delete-button"
        ...
        {shouldRenderAddForm && (
          ...
          >
            <div className="asset-portfolio-summary-box asset-portfolio-summary-box--amazon">
              <div
