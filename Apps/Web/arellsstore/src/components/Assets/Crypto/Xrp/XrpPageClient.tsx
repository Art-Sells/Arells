...
const XrpPageClient: React.FC = () => {
  ...
  /** Survives `<Xrp key={sessionResetKey} />` remounts so session-clear-on-mount runs once per page visit. */
  ...
  return (
    <div className="asset-page asset-page--xrp" ref={pageRef}>
            ...
            <div className="asset-session-reset-spinner-wrap asset-profit-summary asset-profit-summary--xrp">
              <div className="asset-session-reset-spinner" aria-hidden="true">
                <div
                  ...
                  style={{ borderColor: 'rgba(30, 41, 59, 0.2)', borderTopColor: 'rgba(15, 23, 42, 0.55)' }}
                />
              </div>
            </div>
      ...
      <Xrp key={`session-reset-${sessionResetKeyValue}`} sessionMountClearGuardRef={sessionMountClearGuardRef} />
      ...
      <div className="asset-footer-share-sentence">
        share this<br />
        if you believe<br />
        <span className="asset-footer-share-sentence-asset">XRP</span>
        <br />
        should never<br />
        lose value
      </div>
