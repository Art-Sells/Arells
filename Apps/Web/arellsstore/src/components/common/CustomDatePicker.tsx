...
export default function CustomDatePicker({ value, onChange, className, placeholder = 'Select date', asset }: Props) {
  ...
  const themeVars = useMemo((): React.CSSProperties => {
    switch (theme) {
      ...
      case 'tron':
        return {
          '--asset-line-color': 'rgb(255, 0, 19)',
          '--asset-slogan-color': 'rgb(180, 0, 24)',
          '--asset-border-color': 'rgba(255, 0, 19, 0.42)',
        } as React.CSSProperties;
      case 'doge':
        return {
          '--asset-line-color': 'rgb(194, 166, 51)',
          '--asset-slogan-color': 'rgb(130, 100, 20)',
          '--asset-border-color': 'rgba(194, 166, 51, 0.42)',
        } as React.CSSProperties;
      case 'cardano':
        return {
          '--asset-line-color': 'rgb(0, 51, 173)',
          '--asset-slogan-color': 'rgb(0, 38, 130)',
          '--asset-border-color': 'rgba(0, 51, 173, 0.42)',
        } as React.CSSProperties;
      case 'stellar':
        return {
          '--asset-line-color': 'rgb(0, 0, 0)',
          '--asset-slogan-color': 'rgb(17, 17, 17)',
          '--asset-border-color': 'rgba(0, 0, 0, 0.45)',
        } as React.CSSProperties;
      case 'bch':
        return {
      ...
      case 'apple':
        return {
          '--asset-line-color': 'rgb(85, 85, 85)',
          '--asset-slogan-color': 'rgb(51, 51, 51)',
          '--asset-border-color': 'rgba(85, 85, 85, 0.42)',
        } as React.CSSProperties;
      case 'alphabet':
        return {
