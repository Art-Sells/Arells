...
import './css/assets/crypto/stellar-asset-rules.css';
...
/** Default tab icons; `/bitcoin`, `/ethereum`, `/bnb`, `/solana`, `/tron`, `/cardano`, `/stellar`, `/bitcoin-cash`, `/vavity` override via their own `metadata.icons`. */
