...
const VavityEthereum: React.FC = () => {
    ...
    const loadRangePrice = async () => {
      ...
      try {
        const [solidResp, liquidResp] = await Promise.all([
          axios.get('/api/assets/crypto/ethereum/ethereumVapaHistoricalPrice', { params: { date: isoDate, mode: 'solid' } }),
          axios.get('/api/assets/crypto/ethereum/ethereumVapaHistoricalPrice', { params: { date: isoDate, mode: 'liquid' } }),
        ]);
  ...
  useEffect(() => {
    ...
    const loadHistorical = async () => {
      ...
      try {
        const [solidResp, liquidResp] = await Promise.all([
          axios.get('/api/assets/crypto/ethereum/ethereumVapaHistoricalPrice', {
                            ...
                            <React.Fragment key={investmentId}>
                              ...
                              >
                                ...
                                <div className="asset-investment-metrics">
                                    ...
                                    <button
                                      type="button"
                                      className="asset-range-button asset-range-button--ethereum asset-delete-button asset-investment-delete-button"
                    ...
                    <React.Fragment key={investmentId}>
                      ...
                      >
                        ...
                        <>
                            ...
                            <button
                              type="button"
                              className="asset-delete-button asset-investment-delete-button"
                              disabled={deleteLocked}
                              onClick={() => {
                                if (
                                  deleteLockRef.current ||
