            ...
            <div className="asset-invest-form-metrics-panel asset-invest-form-metrics-panel--microsoft">
              <div className="asset-invest-form-metrics">
                <div className="asset-metric-row asset-invest-form-row">
                  <span className="asset-metric-title--microsoft asset-invest-form-metric-title">Purchased Value</span>
                  <span
                ...
                <div className="asset-metric-row asset-invest-form-row">
                  <span className="asset-metric-title--microsoft asset-invest-form-metric-title">Current Value</span>
                  <span
            ...
            <div className="asset-invest-form-controls asset-invest-form-controls--microsoft">
              <div className="asset-invest-form-field">
                <div className="asset-metric-row asset-invest-form-field-label">
                  <span className="asset-metric-title--microsoft">{ASSET.ticker} amount</span>
                </div>
          ...
          <>
            ...
            >
              <div ref={investmentsWholeContentRef}>
                {showInvestmentsHeader && (
                  <h2 className="asset-investments-header">
                    <span className="asset-portfolio-title-muted">my microsoft</span>
                  </h2>
                )}
                <div
              ...
              <div className="asset-metric-row asset-money-row" style={{ marginBottom: '8px', justifyContent: 'center' }}>
                <span className="asset-metric-title--microsoft" style={{ display: 'inline-block', marginTop: 30 }}>
                  Purchased Value
                </span>
                <div
              ...
              <div className="asset-metric-row asset-money-row" style={{ marginBottom: '8px', justifyContent: 'center' }}>
                <span className="asset-metric-title--microsoft">
                  Current Value
                </span>
                <div
                  ref={currentValueRef}
                        ...
                        return (
                          ...
                          >
                            <span ref={profitInlineAnimRef} className="asset-profit-range-anim">
                              <span className="asset-metric-inline-title--microsoft">
                            ...
                            >
                              ...
                              <div className="asset-investment-metrics">
                                  <div className="asset-metric-row asset-money-row" style={{ justifyContent: 'center' }}>
                                    <span className="asset-metric-title--microsoft" style={{ marginTop: 20 }}>
                                      Purchased Value
                                    </span>
                                  ...
                                  <div className="asset-metric-row asset-money-row" style={{ justifyContent: 'center' }}>
                                    <span className="asset-metric-title--microsoft">Current Value</span>
                                    <span className="asset-money-wrap">
                                      <span className="asset-metric-symbol--microsoft">$</span>
                                      <span className="asset-metric-value">
