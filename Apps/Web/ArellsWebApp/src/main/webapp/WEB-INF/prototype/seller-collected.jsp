...
<!-- Below information for social media sharing and search-engine/browser optimization -->		
		...
		<meta property="og:title" content="Arells">
				<!-- Change below link after test -->
		<meta propety="og:url" content="https://arells.com/prototype-seller-collected">
...
<body>
	...
	<!-- Change below links after test -->
		<a id="icon-link-seller-collected" href="/">
		...
		<a id="cart-link-connected-seller-collected" href="/prototype-cart" style="display: none;">
			<img id="cart-icon-seller-collected" src="/icons&images/prototype/shopping-cart-empty.png"/>
		</a>
		<a id="cart-link-full-seller-collected" href="/prototype-cart" style="display: none;">
...
<!-- Change below link after test -->
		<a id="created-seller-collected" href="/prototype-seller-created">Created</a>	
