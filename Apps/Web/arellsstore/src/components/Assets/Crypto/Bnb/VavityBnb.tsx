...
const VavityBnb: React.FC<VavityBnbProps> = ({ sessionMountClearGuardRef }) => {
    ...
    const loadRangePrice = async () => {
      ...
      try {
        const [solidResp, liquidResp] = await Promise.all([
          axios.get('/api/assets/crypto/bnb/bnbVapaHistoricalPrice', { params: { date: isoDate, mode: 'solid' } }),
          axios.get('/api/assets/crypto/bnb/bnbVapaHistoricalPrice', { params: { date: isoDate, mode: 'liquid' } }),
        ]);
  ...
  useEffect(() => {
    ...
    const loadMock = async () => {
      try {
        const resp = await axios.get('/api/assets/crypto/bnb/bnbMockPortfolio');
  ...
  useEffect(() => {
    ...
    const loadHistorical = async () => {
      ...
      try {
        const [solidResp, liquidResp] = await Promise.all([
          axios.get('/api/assets/crypto/bnb/bnbVapaHistoricalPrice', {
      ...
      <div className="asset-invest-form">
        <div className="asset-submit-form">
          <div className="asset-metric-row asset-invest-form-heading">
            <span className="asset-metric-title--bnb" style={{ fontWeight: 800 }}>
              {label}
            </span>
          </div>

          <div className="asset-invest-form-body asset-invest-form-body--bnb">
            <div className="asset-invest-form-metrics-panel asset-invest-form-metrics-panel--bnb">
              <div className="asset-invest-form-metrics">
                ...
                <div className="asset-metric-row asset-invest-form-row">
                  <span className="asset-metric-title--bnb asset-invest-form-metric-title">{profitRow.title}</span>
                  <span
                    className={`asset-money-wrap asset-profit-range-anim${
                      formValuesHidden || formCalcHidden ? ' is-hidden' : ''
                    }`}
                  ...
                  >
                    {profitRow.prefix ? (
                      <span className="asset-metric-inline-symbol--bnb">{profitRow.prefix}</span>
                    ) : null}
            ...
            <div className="asset-invest-form-controls asset-invest-form-controls--bnb">
              <div className="asset-invest-form-field">
                ...
                <div className="asset-invest-form-field-control">
                  <input
                    className="asset-invest-input asset-invest-input--bnb"
                    type="text"
                    inputMode="decimal"
                    pattern="^[0-9]*\\.?[0-9]*$"
                    value={tokenAmount}
  ...
  return (
    <>
      <div className="asset-page-content asset-page-content--bnb page-slide-down">
      <div
        className="asset-panel asset-panel--bnb asset-header-panel asset-section-slide"
        ref={headerPanelRef}
      >
        <a
          className="asset-title-badge asset-title-badge--bnb asset-title-badge--section"
        ...
        <div
          className="asset-panel asset-panel--bnb asset-price-chart-row asset-price-chart-row--combined"
          style={{ overflow: 'visible' }}
      >
          <div
            className="asset-price-panel asset-price-panel--bnb asset-section-slide"
            style={{
              padding: '30px',
      ...
      >
            <div className="asset-metric-row">
              <span className="asset-metric-title--bnb">Price:</span>
            ...
            <div className="asset-metric-row">
              <span className="asset-metric-title--bnb">Market Cap:</span>
              <span className="asset-metric-value-wrap">
                {!headerNumbersVisible && (
            ...
            <div className="asset-metric-row">
              <span className="asset-metric-value-wrap">
                {!headerNumbersVisible && (
                  <span className={`asset-number-loader asset-number-loader--bnb asset-number-loader--narrow asset-number-loader--overlay${shimmersFading ? ' is-hidden' : ''}`} />
                )}
              {percentageIncrease > 0 ? (
                <span className={`asset-metric-trend-icon asset-metric-trend-icon--bnb asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`} aria-hidden="true" />
              ) : (
                <span
                  className={`asset-metric-trend-icon asset-metric-trend-icon--down asset-metric-trend-icon--bnb asset-mount-fade-2s${headerNumbersVisible ? ' is-visible' : ''}`}
                  aria-hidden="true"
                />
              )}
              <span
              ...
              <span
                className={`asset-metric-symbol--bnb asset-metric-percent-symbol--bnb asset-mount-fade-2s${
            ...
            <div
              className="asset-panel asset-panel--bnb asset-section-slide asset-market-controls"
            >
              <div className="asset-market-controls-header">
                <div className="asset-profit-summary asset-profit-summary--bnb" style={{ marginBottom: 0 }}>
                  <div className="asset-metric-inline-row">
                    {(() => {
                      ...
                      return (
                        <>
                          <span className="asset-metric-inline-title--bnb asset-market-status-title">
                            {label}:
                          </span>{' '}
                          <span
                ...
                {chartRanges.map((range) => {
                  ...
                  return (
                    <button
                      key={range.label}
                      type="button"
                      className={`asset-range-button asset-range-button--bnb${isActive ? ' is-active' : ''}`}
                      disabled={isActive}
                      onClick={() => {
                        if (isActive) return;
          ...
          <div
              className="asset-panel asset-panel--bnb asset-section-slide asset-chart-panel asset-chart-panel--bnb"
            style={{
              padding: '0px',
                position: 'relative',
          ...
          >
            {chartHoverPoint != null && displayPoint && (
                <div className="asset-chart-date-badge asset-chart-date-badge--bnb">
                <span className="asset-metric-inline-title--bnb">Date:</span>{' '}
              ...
              <div className={`asset-chart-loader${chartReady && !forceChartLoader ? ' is-hidden' : ''}`}>
                <div className="asset-chart-grid-shimmer asset-chart-grid-shimmer--bnb">
              ...
              <div
                ...
                style={{
                  ...
                  zIndex: 0,
                  backgroundImage:
                    'repeating-linear-gradient(to right, rgba(243, 186, 47, 0.1) 0px, rgba(243, 186, 47, 0.1) 1px, transparent 1px, transparent 30px), repeating-linear-gradient(to bottom, rgba(243, 186, 47, 0.1) 0px, rgba(243, 186, 47, 0.1) 1px, transparent 1px, transparent 30px)',
                }}
              />
              <div
            ...
            <BnbChart
              history={chartHistoryForLine || []}
                  ...
                  activeColor="rgba(243, 186, 47, 0.6)"
                  markerColor="rgba(243, 186, 47, 1)"
                  ...
                  markerShadow="-5px 0 14px rgba(243, 186, 47, 0.26), 0 7px 10px rgba(243, 186, 47, 0.18)"
                  animateOn={false}
                  animateDelayMs={0}
          ...
          <div className="asset-panel asset-panel--bnb asset-reality-toggle-shell">
            <div className="asset-reality-toggle-row asset-reality-toggle-row--bnb">
      ...
      <div
        className={`asset-panel asset-panel--bnb asset-portfolio-center asset-section-slide${
      ...
      >
        {!hasInvestmentsUI && !showInitialFetchLoader && (isSignedIn || email) ? (
              ...
              {false && !isSignedIn && !email && (
                ...
                >
                  <p className="asset-signin-believe-prompt">
                    Do you believe BNB should never lose value?
                  </p>
                  <Link
                    href="/signin"
          ...
          <>
            ...
            <div
              ...
              className={`asset-slide-panel${isClearingInvestments ? ' asset-slide-panel--clearing asset-slide-panel--clearing-bnb' : ''}`}
              style={{
            ...
            >
              <div ref={investmentsWholeContentRef}>
                ...
                <div
                  className={`asset-portfolio-summary-box asset-portfolio-summary-box--bnb${
              ...
              <div
                className="asset-panel asset-panel--bnb asset-profit-block asset-slide-in"
                style={{ 
                  padding: '20px 20px 20px', marginBottom: '10px', width: '92%', marginLeft: 'auto', marginRight: 'auto' }}
              >
                <div className="asset-profit-summary asset-profit-summary--bnb">
                  <div className="asset-metric-inline-row">
                {(() => {
                          ...
                          >
                            <span ref={profitInlineAnimRef} className="asset-profit-range-anim">
                              ...
                              >
                                ...
                                >
                                  <span className="asset-metric-symbol--bnb">
                                    {isProfit ? '+$' : '-$'}
                                  </span>
              ...
              <div className="asset-portfolio-actions asset-portfolio-actions--add">
                <button
                  className={`asset-action-button asset-action-button--bnb asset-action-button--invest-add${
          ...
          {false && !isSignedIn && !email && (
            <div className="asset-empty-signin">
              ...
              >
                ...
                >
                  <button
                    className={`asset-action-button asset-action-button--bnb asset-action-button--invest-show${
                ...
                {showInvestmentsList && (
                  ...
                  >
                    ...
                    <div
                      className={`asset-investments-wrap asset-investments-wrap--bnb asset-slide-panel${
                        ...
                        return (
                          <React.Fragment key={investmentId}>
                            ...
                            >
                              ...
                              <div
                                className={`asset-panel asset-panel--bnb${isPendingDelete ? ' is-pending-delete' : ''}${
                              ...
                              >
                                <div
                                  ...
                                  style={{
                                    ...
                                    borderTopColor: 'rgba(243, 186, 47, 0.5)',
                                  }}
                                />
                              </div>
                              <div className="asset-investment-metrics">
                                  ...
                                  <div className="asset-metric-row asset-money-row" style={{ justifyContent: 'center' }}>
                                    {(() => {
                                      ...
                                      return (
                                        <>
                                          <span className="asset-metric-title--bnb">{title}</span>
                                          <span className="asset-money-wrap">
                                            <span className="asset-metric-inline-symbol--bnb">{prefix}</span>
                                            <span className="asset-metric-value">
                                  ...
                                  <button
                                    type="button"
                                    className="asset-range-button asset-range-button--bnb asset-delete-button asset-investment-delete-button"
        ...
        {shouldRenderAddForm && (
          ...
          >
            <div className="asset-portfolio-summary-box asset-portfolio-summary-box--bnb">
              <div
